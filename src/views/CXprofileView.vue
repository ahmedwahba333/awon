<template>
  <div class="bg">
    ...
    <div class="container grid mt-5">
      <div class="row searchCard pt-4 pb-4">
        <div class="setting">
          <svg
      ...
      <div class="row searchCard pt-4 pb-4 mt-5">
        ...
        <div class="order d-flex flex-wrap">
          <template v-for="(worker,i) in worker.slice(0,3)" :key="i">
          <div class="col-lg-3 col-md-4 col-sm-4 m-3">
            <p class="searchKe mx-4">
              {{ worker.First_name }} {{ worker.Last_name }}
            </p>
            <p class="searchKe mx-4">{{ worker.Service_1_price }} LE</p>
            <!-- <p class="searchKe mx-4">{{  order[i]["Order_Date"] }}</p> -->
            <router-link :to="`/./writereview / ${ cx.id } `">
              <a class="btn d-block m-auto mb-3 mt-4"
                >Write review</a
              ></router-link
            >
