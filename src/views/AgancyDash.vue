...
export default {
      ...
      axios
        ...
        .then((res) => {
          ...
          for (let x = 0; x < this.orders.length; x++) {
            ...
            if (this.orders[x]["Agency_id"] == JSON.parse(localStorage.getItem("agInfo"))["id"]) {
            ...
            datasets: [
              {
                ...
                data: [this.Canceled.length, this.Pending.length, this.NoDelivered],
  ...
  // mounted() {
  // let data = {};
  // console.log("testttttttttttttt ", this.NoDelivered);
  // const ctx = document.getElementById("myChart");
  // const ctx2 = document.getElementById("myChart2");
  // new Chart(ctx, {
  //   type: "line",
