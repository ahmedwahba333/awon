  ...
  <div class="bg container-fluid">
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/plumber3.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Yosef Tarek</h5>
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/plumber2.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Ahmed Osama</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/plumber1.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Ali Omar</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Ali Fayez</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Mahmoud Ahmed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Yosef Osama</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Yasser Ahmed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Osama Yosef</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
