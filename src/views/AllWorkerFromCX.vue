  ...
  <div class="bg">
    ...
    <div class="container-fluid">
      <div class="row pt-3 justify-content-center align-items-center">
        ...
        <ul class="dropdown-menu">
          <li>
            <div class="dropdown-item">
              ...
              <div class="d-flex align-items-center gap-3">
                <div>
                  <input type="checkbox" id="Cleaning" class="form-check-input" :value="Cleaning" v-model="Cleaning" />
                  <label for="Cleaning" class="form-check-label mt-1 ms-1">Cleaning</label>
                </div>
                <div>
                  <input type="checkbox" id="Gardening" class="form-check-input" />
                  <label for="Gardening" class="form-check-label mt-1 ms-1">Gardening</label>
                </div>
              </div>
            </div>
          </li>
          ...
          <li>
            <div class="dropdown-item">
              ...
              <div class="d-flex align-items-center gap-3">
                <div>
                  <input type="checkbox" id="hGaurd" class="form-check-input" />
                  <label for="hGaurd" class="form-check-label mt-1 ms-1">House Gaurd</label>
                </div>
                <div>
                  <input type="checkbox" id="Driver" class="form-check-input" />
                  <label for="Driver" class="form-check-label mt-1 ms-1">Driver</label>
                </div>
              </div>
            </div>
          </li>
          ...
          <li>
            <div class="dropdown-item">
              ...
              <div class="d-flex align-items-center gap-3">
                <div>
                  <input type="checkbox" id="Plumbing" class="form-check-input" />
                  <label for="Plumbing" class="form-check-label mt-1 ms-1">Plumbing</label>
                </div>
                <div>
                  <input type="checkbox" id="Carpentry" class="form-check-input" />
                  <label for="Carpentry" class="form-check-label mt-1 ms-1">Carpentry</label>
                </div>
                <div>
                  <input type="checkbox" id="mFurniture" class="form-check-input" />
                  <label for="mFurniture" class="form-check-label mt-1 ms-1">Moving Furniture</label>
                </div>
              </div>
            </div>
          </li>
          ...
          <li>
            <div class="dropdown-item">
              ...
              <div class="d-flex align-items-center gap-3">
                <div>
                  <input type="checkbox" id="Chefs" class="form-check-input" />
                  <label for="Chefs" class="form-check-label mt-1 ms-1">Chefs</label>
                </div>
                <div>
                  <input type="checkbox" id="Catering" class="form-check-input" />
                  <label for="Catering" class="form-check-label mt-1 ms-1">Food Catering</label>
                </div>
              </div>
            </div>
          </li>
          ...
          <li>
            <div class="dropdown-item">
              ...
              <div class="d-flex align-items-center gap-3">
                <div>
                  <input type="checkbox" id="Babysitting" class="form-check-input" />
                  <label for="Babysitting" class="form-check-label mt-1 ms-1">Babysitting</label>
                </div>
                <div>
                  <input type="checkbox" id="ecare" class="form-check-input" />
                  <label for="ecare" class="form-check-label mt-1 ms-1">Elderly care</label>
                </div>
                <div>
                  <input type="checkbox" id="Nursing" class="form-check-input" />
                  <label for="Nursing" class="form-check-label mt-1 ms-1">Home Nursing</label>
                </div>
              </div>
            </div>
          </li>
        ...
        <input class="search mt-2" type="search" placeholder="search via services" v-model="input" />
      </div>
          ...
          <div class="carousel-inner mb-5">
            ...
            <div class="carousel-item active" data-bs-interval="10000">
              <div class="row justify-content-center gap-4">
                <div class="card mb-4 col-md-4 col-sm-6 col-6" v-for="worker in  handleSearch.slice(1, 70)"
                  :key="worker.id" style="width: 25rem; border-radius: 15px;">
                  ...
                  <div class="card-body">
                    ...
                    <p class="card-text text-start" v-if="worker.Service_1 != null">
                      {{ worker["Service_1"] }}:
                      {{ worker["Service_1_price"] }}
                    </p>
                    <p class="card-text text-start" v-if="worker.Service_2 != null">
                      {{ worker["Service_2"] }}:
                      {{ worker["Service_2_price"] }}
                    </p>
                    <p class="card-text text-start" v-if="worker.Service_3 != null">
                      {{ worker["Service_3"] }}:
                      {{ worker["Service_3_price"] }}
                    </p>
                    <p class="card-text text-start" v-if="worker.Service_4 != null">
                      {{ worker["Service_4"] }}
                      {{ worker["Service_4_price"] }}
                    </p>
                    <p class="card-text text-start">Exp years:
                      {{ worker["Experience"] }}
                    </p>
            ...
            <!-- Carasol slides -->
            <div class="carousel-item mb-0 pb-0" data-bs-interval="2000" v-for="i in 1" :key="i">
              <div class="row justify-content-center gap-4">
                <div class="card mb-4 col-md-4 col-sm-6 col-6" v-for="worker in  handleSearch.slice(71)" :key="worker.id"
