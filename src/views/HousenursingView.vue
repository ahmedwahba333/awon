  ...
  <div class="bg container-fluid">
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/nurse2.jpg"
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/nurse1.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/nurse3.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Safaa Mohamed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Nada Yasser</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Amr Ismael</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
