  ...
  <div class="bg container-fluid">
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Nermeen Tarek</h5>
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/babysitter2.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/babysitter3.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Ola Tarek</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Mai Sayed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Fayza Mohamed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Maha Bassem</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Mariem Ahmed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Aya Osama</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Ola Fayez</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
