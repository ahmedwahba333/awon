<template>
    ...
    <div class="container grid">
      ...
      <!-- Worker Personal Details -->
        <div class="row mt-sm-3 mb-sm-3 firstRow">
            ...
            <div class="col-lg-8 col-md-9 col-sm-9"> 
                <div class="row worker">
                    <div class="col-lg-2 col-sm-3 mt-sm-2 mb-sm-2">
        ...
        <div class="row grid ServiceDet mb-5 ">
            ...
            <div class="col-12 mt-3">
                <table class="table" style="color:$blueColor; --bs-table-color:$blueColor;">
                       <thead>
                         <tr>
        ...
        <div class="carousel-inner mb-5">
          ...
          <div class="carousel-item active" data-bs-interval="10000">
             <div class="row reviewBox">
                ...
                <div class="col-lg-6 col-md-10 col-sm-5 innerReview mb-3">
            ...
            <div class="row reviewBox">
                ...
                <div class="col-lg-6 col-md-10 col-sm-5 innerReview">
