<template>
    ...
    <div class="container grid">
      ...
      <!-- Worker Personal Details -->
            ...
            <div class="col-lg-8 col-md-9 col-sm-9"> 
                <div class="row worker">
                    <div class="col-lg-2 col-sm-3 mt-2 mb-2">
                        <svg xmlns="http://www.w3.org/2000/svg" height="5em" viewBox="0 0 512 512" fill="#F97B22">
                    ...
                    <div class="col-lg-10 col-md- col-sm-9" >
        ...
        <div class="row grid ServiceDet mb-4 ">
         ...
         <!-- Worker Reviews -->
        <div class="row reviewsCard mb-5">
          <div class="col-12 mx-5 mt-3 mb-3">
             <p>Worker Reviews</p>
          </div>
        ...
        <div class="col-12">
         <div id="carouselExampleDark" class="carousel carousel-dark slide">
           ...
           <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-circle-fill active" viewBox="0 0 16 16" data-bs-slide-to="0"  >
  <circle cx="8" cy="8" r="8"/>
        ...
        <div class="carousel-inner">
          ...
          <div class="carousel-item active" data-bs-interval="10000">
             <div class="row reviewBox">
                ...
                <div class="col-lg-6 col-md-10 col-sm-6 innerReview">
       
                   <div>Suzy Nabil</div>
                    <div v-for="i in 4" :key="i" class="stars">
        ...
        <!-- Carasol slides -->
    <div class="carousel-item" data-bs-interval="2000" v-for="i in 2" :key="i">
        <div class="row reviewBox">
                <div class="col-1"> 
                   <img src="../assets/workerimg.jpg" class="reviewImg rounded-circle">
                </div>
