    ...
    <div class="bg">
        ...
        <div class="container">
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div id="exampleModalToggle" class="modal fade" aria-hidden="true" aria-labelledby="exampleModalToggleLabel"
                    tabindex="-1">
                    <div class="modal-dialog modal-confirm">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <router-link to="/"><button class="btn btn-success btn-block"
                                        data-dismiss="modal">OK</button></router-link>
                            </div>
                        </div>
                    </div>
                </div>
