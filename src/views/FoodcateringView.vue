  ...
  <div class="bg container-fluid">
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/foodserver.jpg"
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/foodserver2.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Yasser Osama</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/foodserver3.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Ahmed Tarek</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">yassin Mohamed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Mahmoud Bassem</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Ali Ahmed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Qasim Fayez</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
