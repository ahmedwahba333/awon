  ...
  <div class="bg container-fluid">
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/gaurd1.jpg"
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/guard2.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
      ...
      <div class="card mb-4" style="width: 18rem">
        <img
          src="../assets/subservices/gaurd3.jpg"
          class="card-img-top Clip-path:circle()"
          alt="..."
        />
        <div class="card-body">
          <h5 class="card-title">Tarek Omar</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Ahmed Salama</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Fayez Mohamed</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
    ...
    <div class="row justify-content-center my-5 gap-5">
      ...
      <div class="card mb-4" style="width: 18rem">
        ...
        />
        <div class="card-body">
          <h5 class="card-title">Yasser Fayez</h5>
          <p class="card-text">16 St. Emad Eldein - Down Town - Cairo</p>
          <svg
            class="d-block m-auto"
            xmlns="http://www.w3.org/2000/svg"
