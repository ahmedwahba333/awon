        ...
        <div class="d-flex justify-content-center align-items-center py-5">
            <div class="text-center">
                ...
                <div class="myCon">
                    ...
                    <router-link to="/" class="title-heading"><img class="logo-img" src="../../../assets/aown-dark-sm.png"
                    ...
                    <div class="forget-pass my-2">
                        <router-link to="/cpanel-login">Login
                ...
                <form>
                    <div class="d-flex flex-column text-start mb-2">
                        <label class="form-label label-text" for="email">Enter Confirmation Code</label>
                        <input class="form-control myInput" type="text" name="email" id="email">
                    </div>
                </form>
                <div>
                    <router-link to="/cpanel-setup-password"><button class="btn-login">confirm code</button></router-link>
                </div>
            </div>
        </div>
        <FooterComponent />
