...
</svg><span class="fs-5 ms-3 d-none d-sm-inline">Home</span>
                        </router-link>
                    </li>
                    <li class="nav-item py-2 py-sm-0 ">
                        <router-link to="#" class="nav-link ">
...
</svg><span class="fs-5 ms-3 d-none d-sm-inline">Worcker</span>
                        </router-link>
                    </li>
                    <li class="nav-item py-2 py-sm-0 ">
                        <router-link to="#" class="nav-link ">
...
</svg><span class="fs-5 ms-3 d-none d-sm-inline">Serveise history</span>
                        </router-link>
                    </li>
                    <li class="nav-item py-2 py-sm-0 ">
                        <router-link to="#" class="nav-link ">
...
</svg><span class="fs-5 ms-3 d-none d-sm-inline">rewiews</span>
                        </router-link>
                    </li>
                </ul>
            </div>
